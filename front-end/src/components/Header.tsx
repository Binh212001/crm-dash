          ...
          <div className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Payment for order #12344 completed</p>
          ...
          <div className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Product "Widget X" is running low</p>
                <p className="text-xs text-gray-400">3 hours ago</p>
              </div>
            </div>
          </div>
          <div className="px-4 py-2 text-center border-t border-gray-100">
            <span className="text-sm text-primary hover:text-primary-dark cursor-pointer">View all notifications</span>
          </div>
        </Dropdown>
        ...
        <Dropdown
          trigger={
            <div className="flex items-center space-x-1 cursor-pointer px-2 py-1 rounded hover:bg-gray-100">
              <img src="https://flagcdn.com/gb.svg" alt="English" className="h-5 w-7 rounded object-cover" />
              <span className="text-sm text-gray-700">English</span>
              <svg className="h-3 w-3 text-gray-400 ml-1" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
        ...
        >
          <div className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer">
            <div className="flex items-center space-x-2">
              <img src="https://flagcdn.com/gb.svg" alt="English" className="h-4 w-6 rounded object-cover" />
              <span>English</span>
            </div>
          </div>
          <div className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer">
            <div className="flex items-center space-x-2">
              <img src="https://flagcdn.com/es.svg" alt="Spanish" className="h-4 w-6 rounded object-cover" />
              <span>Español</span>
            </div>
          </div>
          <div className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer">
            <div className="flex items-center space-x-2">
              <img src="https://flagcdn.com/fr.svg" alt="French" className="h-4 w-6 rounded object-cover" />
              <span>Français</span>
            </div>
          </div>
        </Dropdown>
          ...
          trigger={
            <div className="flex items-center space-x-2 cursor-pointer px-2 py-1 rounded hover:bg-gray-100">
              ...
              <div className="flex flex-col items-start">
                <span className="text-sm font-medium text-gray-900">Meet Roy</span>
