...
import { BunnyUploadRes } from "../bunny/bunny-file-interceptor";
...
export class UserService {
  ...
  async findAll(
    reqDto: ListUserDto
  ): Promise<OffsetPaginatedDto<UserResponseDto>> {
    const { q } = reqDto;
    ...
    return new OffsetPaginatedDto(
      plainToInstance(UserResponseDto, base),
      metaDto
    );
  }
